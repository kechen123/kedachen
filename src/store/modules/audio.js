...
const audio = {
  ...
  getters: {
    ...
    getMusicRiTui: state => state.musicRiTui,
    ...
    getMusicUserRecord: state => state.musicUserRecord,
  },
  mutations: {
    setCurrentAudio (state, obj) {
      state.currentAudio = obj
    },
    ...
    setMusicRiTui (state, obj) {
      state.musicRiTui = obj
    },
    setMusicSearchList (state, obj) {
      state.musicSearchList = obj
    },
    setMusicSheetList (state, obj) {
      state.musicSheetList = obj
    },
    setMusicPlayList (state, obj) {
      state.musicPlayList = obj
    },
    ...
    setMusicUserRecord (state, obj) {
      state.musicUserRecord = obj
    },
  },
  actions: {
    ...
    set_MusicRiTui ({commit}, obj) {
      commit('setMusicRiTui', obj)
    },
    ...
    set_MusicUserRecord ({commit}, obj) {
      commit('setMusicUserRecord', obj)
    }
